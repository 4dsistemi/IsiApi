...
public class ProductForniture extends LastModifiedTables {
    ...
    public ProductForniture(String name, String barcode_value, int unity_id, float price, float quantity, int blister_pieces, Integer forniture_id, float deadline, int reorder, String note) {
        this.name = name;
